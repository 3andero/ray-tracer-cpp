...
main(int, char **)
{
	...
	let lamb1 = MaterialVariant{Lambertian{{0.3, 0.61, 0.77}}};
	let lamb2 = MaterialVariant{Lambertian{{1., 0.55, 0.6}}};
	let m1 = MaterialVariant{Mirror{{0.9, 0.9, 0.9}, 0.}};
	let rf1 = MaterialVariant{Refraction{{0.8, 0.85, 0.9}, 1.5}};
	let rf2 = MaterialVariant{Refraction{{0.8, 0.85, 0.9}, 1.3}};
